...
bool sonParejaCeldas(Tablero t, int fila1, int col1, int fila2, int col2){
	...
	bool pareja = false;
	if((fila1 + 1 == fila2 && (col1 == col2 || col1 + 1 == col2 || col1 - 1 == col2 || (col1 == t.col_ult && col2 == 0))) || // Fila de abajo pegada arriba, en diagonal por arriba o en la primera columna
		(fila1 - 1 == fila2 && (col1 == col2 || col1 + 1 == col2 || col1 - 1 == col2 || (col1 == 0 && col2 == t.col_ult))) || // Fila de arriba pegada abajo o en diagonal por abajo
